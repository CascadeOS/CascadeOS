...
fn fillInBuilders(
    ...
    for (line_debug_info) |line_info| {
        ...
        // address instruction
        {
            ...
            switch (difference) {
                2 => try location_program.addInstruction(.increment_address_two),
                3 => try location_program.addInstruction(.increment_address_three),
                4 => try location_program.addInstruction(.increment_address_four),
                5 => try location_program.addInstruction(.increment_address_five),
                6 => try location_program.addInstruction(.increment_address_six),
                7 => try location_program.addInstruction(.increment_address_seven),
                8 => try location_program.addInstruction(.increment_address_eight),
                9 => try location_program.addInstruction(.increment_address_nine),
                10 => try location_program.addInstruction(.increment_address_ten),
                11 => try location_program.addInstruction(.increment_address_eleven),
                12 => try location_program.addInstruction(.increment_address_twelve),
                13 => try location_program.addInstruction(.increment_address_thirteen),
                14 => try location_program.addInstruction(.increment_address_fourteen),
                15 => try location_program.addInstruction(.increment_address_fifteen),
                16 => try location_program.addInstruction(.increment_address_sixteen),
                17 => try location_program.addInstruction(.increment_address_seventeen),
                18 => try location_program.addInstruction(.increment_address_eighteen),
                19 => try location_program.addInstruction(.increment_address_nineteen),
                20 => try location_program.addInstruction(.increment_address_twenty),
                21 => try location_program.addInstruction(.increment_address_twenty_one),
                22 => try location_program.addInstruction(.increment_address_twenty_two),
                23 => try location_program.addInstruction(.increment_address_twenty_three),
                24 => try location_program.addInstruction(.increment_address_twenty_four),
                25 => try location_program.addInstruction(.increment_address_twenty_five),
                26 => try location_program.addInstruction(.increment_address_twenty_six),
                27 => try location_program.addInstruction(.increment_address_twenty_seven),
                28 => try location_program.addInstruction(.increment_address_twenty_eight),
                29 => try location_program.addInstruction(.increment_address_twenty_nine),
                30 => try location_program.addInstruction(.increment_address_thirty),
                31 => try location_program.addInstruction(.increment_address_thirty_one),
                32 => try location_program.addInstruction(.increment_address_thirty_two),
        ...
        if (line_changed) {
            ...
            switch (difference) {
                ...
                6 => try location_program.addInstruction(.increment_line_six),
                7 => try location_program.addInstruction(.increment_line_seven),
                8 => try location_program.addInstruction(.increment_line_eight),
                9 => try location_program.addInstruction(.increment_line_nine),
                10 => try location_program.addInstruction(.increment_line_ten),
                11 => try location_program.addInstruction(.increment_line_eleven),
                12 => try location_program.addInstruction(.increment_line_twelve),
                ...
                -6 => try location_program.addInstruction(.decrement_line_six),
                -7 => try location_program.addInstruction(.decrement_line_seven),
                -8 => try location_program.addInstruction(.decrement_line_eight),
                -9 => try location_program.addInstruction(.decrement_line_nine),
                -10 => try location_program.addInstruction(.decrement_line_ten),
                -11 => try location_program.addInstruction(.decrement_line_eleven),
                -12 => try location_program.addInstruction(.decrement_line_twelve),
