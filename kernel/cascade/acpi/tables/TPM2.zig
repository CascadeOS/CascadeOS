...
pub const TPM2 = extern struct {
    ...
    address: cascade.PhysicalAddress align(1),
    ...
    _log_area_start_address: cascade.PhysicalAddress align(1),
    ...
    pub fn logAreaStartAddress(tpm2: *const TPM2) ?cascade.PhysicalAddress {
        if (tpm2.header.length < @offsetOf(TPM2, "_log_area_start_address") + @sizeOf(cascade.PhysicalAddress)) return null;
    ...
    pub const StartMethodSpecificParameters = extern union {
        ...
        pub const CommandResponseBufferWithAMDMailbox = extern struct {
            ...
            tpm_start_address: cascade.PhysicalAddress align(1),
            ...
            tpm_reply_address: cascade.PhysicalAddress align(1),
