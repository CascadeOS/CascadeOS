...
pub fn Arena(comptime quantum_caching: QuantumCaching) type {
    return struct {
        ...
        pub fn deinit(arena: *@This(), current_task: *cascade.Task) void {
        ...
        ///
        /// O(N) runtime.
        pub fn addSpan(arena: *@This(), current_task: *cascade.Task, base: usize, len: usize) AddSpanError!void {
        ...
        pub fn allocate(arena: *@This(), current_task: *cascade.Task, len: usize, policy: Policy) AllocateError!Allocation {
        ...
        pub fn deallocate(arena: *@This(), current_task: *cascade.Task, allocation: Allocation) void {
        ...
        fn ensureBoundaryTags(arena: *@This(), current_task: *cascade.Task) EnsureBoundaryTagsError!void {
            arena.mutex.lock(current_task);
