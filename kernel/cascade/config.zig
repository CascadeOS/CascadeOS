...
pub const executor = struct {
    ...
    pub const interrupt_source_panic_buffer_size = arch.PageTable.standard_page_size;
};
...
pub const mem = struct {
    ...
    pub const virtual_range_batching_merge_distance = arch.PageTable.standard_page_size.multiplyScalar(4);
};
...
pub const task = struct {
    ...
    pub const kernel_stack_size = arch.PageTable.standard_page_size.multiplyScalar(32); // TODO: why does it need to be this big? - maybe debug only?
