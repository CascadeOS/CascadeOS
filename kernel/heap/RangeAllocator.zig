...
pub fn init(total_range: core.VirtualRange) error{OutOfMemory}!RangeAllocator {
...
pub fn deallocateRange(self: *RangeAllocator, range: core.VirtualRange) error{OutOfMemory}!void {
