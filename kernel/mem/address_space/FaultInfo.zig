...
fn promote(
    ...
    const allocated_frame = kernel.mem.phys.allocator.allocate() catch {
        @panic("NOT IMPLEMENTED"); // TODO https://github.com/openbsd/src/blob/ccf0515516a741ff1b88c77de3fa3bab98a44ab5/sys/uvm/uvm_fault.c#L520
    };
    ...
    switch (object_page) {
        ...
        .page => @panic("NOT IMPLEMENTED"), // TODO https://github.com/openbsd/src/blob/ccf0515516a741ff1b88c77de3fa3bab98a44ab5/sys/uvm/uvm_fault.c#L545
        .need_io => unreachable,
    }
}
